...
אתם מוזמנים לפנות אליי בנוגע *לכל* נושא [במייל הפרטי שלי](mailto:eyalroth1@gmail.com).

אם נתקלתם בבעיה טכנית אני אעריך אם תוכלו לדווח לי עליה דרך
[GitHub ticket](https://github.com/eyalroth/blog-gatsby/issues/new/choose).
אם אין לכם משתמש בGitHub - זה בסדר גמור, אתם יכולים לפנות אליי במייל בדרך הישנה והטובה (:

## מידע שאני אוסף עליכם

האתר הזה עושה שימוש ב[Google Analytics](https://he.wikipedia.org/wiki/Google_Analytics)
בכדי לאסוף סטטיסטיקות שעוזרות לי להבין טוב יותר את השימוש שלכם באתר כדי שאוכל לשפר אותו.
...
כתיבת תגובות דורשת משתמש GitHub (צפייה בהן פתוחה לכולם).
